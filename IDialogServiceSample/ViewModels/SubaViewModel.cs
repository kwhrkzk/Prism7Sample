...
{
    public class SubaViewModel : IConfirmNavigationRequest, IRegionMemberLifetime, IDisposable, INotifyPropertyChanged, IDestructible
    {
...
#pragma warning restore 0067
        ...
        public ReactiveCommand GoToSubBCommand { get; } = new ReactiveCommand();
        ...
        public SubaViewModel()
        {
            GoToSubBCommand.Subscribe(() => RegionNavigationService.RequestNavigate(nameof(SubbView))).AddTo(DisposeCollection);
        }
